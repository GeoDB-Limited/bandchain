...
func (k Keeper) ExchangeDenom(ctx sdk.Context, from, to types2.Denom, amt sdk.Coin, requester sdk.AccAddress) error {
...
func (k Keeper) convertToRate(ctx sdk.Context, from, to types2.Denom, amt sdk.Coin) (sdk.DecCoin, error) {
	rate := k.GetRate(ctx)
