...
func TestGetSetParams(t *testing.T) {
	...
	k.SetParamUint64(ctx, types.KeyBaseRequestGas, 50000)
	...
	require.Equal(t, types.NewParams(1, 10, 30, 50000, 3000, 3, 50, 1000, types.NewCoinDecProto(types.DefaultDataProviderRewardDenom), types.NewCoinProto(types.DefaultDataRequesterBasicFeeDenom)), k.GetParams(ctx))
	...
	k.SetParamUint64(ctx, types.KeyBaseRequestGas, 150000)
	...
	require.Equal(t, types.NewParams(2, 20, 40, 150000, 30000, 5, 80, 10000, types.NewCoinDecProto(types.DefaultDataProviderRewardDenom), types.NewCoinProto(types.DefaultDataRequesterBasicFeeDenom)), k.GetParams(ctx))
}
